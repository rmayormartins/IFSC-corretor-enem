/* ============================================
   ...
   Versão refinada com guia técnico da C1
   e regras anti-viés de banca
   ============================================ */
  ...
  competencias: [
    {
      ...
      guiaAvaliacao: {
        eixos: ["Estrutura sintática", "Desvios gramaticais e de convenções da escrita"],
        estrutura_sintatica: {
          inexistente: "Não há organização frasal minimamente inteligível. Há apenas palavras e/ou grupos isolados sem sintaxe funcional. Se há palavras legíveis, mas sem sintaxe reconhecível, a C1 pode ser 0.",
          deficitaria: "A fluidez da leitura está comprometida. Há truncamentos, justaposições frequentes, ausência de palavras essenciais ou organização frasal muito precária.",
          regular: "Há falhas de estrutura sintática, mas a leitura flui. Podem ocorrer truncamentos pontuais, justaposições indevidas, predominância de parágrafos de período único ou pouca complexidade estrutural.",
          boa: "Há boa organização sintática, com falhas pontuais que não comprometem a fluidez global.",
          excelente: "Períodos completos, bem organizados, com complexidade sintática adequada. Admite, no máximo, uma falha de estrutura sintática."
        },
        desvios: {
          muitos: "Desvios frequentes e/ou diversificados de grafia, acentuação, concordância, regência, pontuação, translineação, paralelismo, crase, pronomes, maiúsculas/minúsculas etc. A avaliação deve considerar o conjunto textual, não apenas a contagem bruta.",
          alguns: "Desvios perceptíveis, mas não excessivos no conjunto textual.",
          poucos: "Poucos desvios, pontuais e não recorrentes.",
          maximo_dois: "No máximo dois desvios em todo o texto."
        },
        regras_decisao: [
...
/* ============================================
   ...
   Integra o guia técnico da C1 e regras anti-viés
   ============================================ */
...
- "justificativa": 2 a 4 frases técnicas e objetivas explicando o nível atribuído
...
{
  "competencias": {
    "c1": {"nota": 0, "justificativa": "", "evidencia": null, "confianca": "alta"},
    "c2": {"nota": 0, "justificativa": "", "evidencia": null, "confianca": "alta"},
    "c3": {"nota": 0, "justificativa": "", "evidencia": null, "confianca": "alta"},
    "c4": {"nota": 0, "justificativa": "", "evidencia": null, "confianca": "alta"},
    "c5": {"nota": 0, "justificativa": "", "evidencia": null, "confianca": "alta"}
  },
  "nota_final": 0,
  "zeramento": null,
  "observacao_geral": ""
